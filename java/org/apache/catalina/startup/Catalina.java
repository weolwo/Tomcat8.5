...
public class Catalina {
     ...
     */
    public void load() {
        System.out.println("开始调用Catalina的load方法");
        if (loaded) {
            return;
        }
        loaded = true;
        ...
        // Create and execute our Digester
        Digester digester = createStartDigester();//解析sever.xml
        System.out.println("解析sever.xml完成。。。");
     ...
     */
    public void start() {
        System.out.println("开始调用Catalina的start方法");
        if (getServer() == null) {
            load();
        }
